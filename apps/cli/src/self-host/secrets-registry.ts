...
export const SECRET_DEFS: SecretDef[] = [
  ...
  {
    key: "PLATINUM_API_KEY",
    category: "sandbox",
    kind: "operator",
    required: false,
  },
  {
    key: "PLATINUM_WEBHOOK_SECRET",
    category: "sandbox",
    kind: "operator",
    required: false,
  },
  ...
  {
    key: "MANAGED_GIT_GITHUB_OWNER",
    category: "managed_git",
    kind: "operator",
    required: false,
  },
  {
    key: "MANAGED_GIT_GITHUB_TOKEN",
    category: "managed_git",
    kind: "operator",
    required: false,
  },
