...
export const ENV_CONTRACT: readonly EnvBinding[] = [
  ...
  b('KORTIX_SANDBOX_TOKEN', 'core', 'session', 'identity', 'Deprecated sandbox credential removed before an assignment child starts.', { secret: true }),
  b('KORTIX_TOKEN', 'core', 'session', 'identity', 'The session-scoped credential used by the daemon and CLI.', { secret: true }),
