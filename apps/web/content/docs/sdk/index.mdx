...
REST API and the agent runtime in one interface. Your app never calls a session
transport directly. The core client is fetch-based and runs in Node, Bun, and
browsers.
