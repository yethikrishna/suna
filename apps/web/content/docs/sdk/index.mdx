...
server-selected OpenCode REST or ACP transport. ACP supports OpenCode, Claude
Code, Codex, and Pi. Your app never calls a harness transport directly. The
core client is fetch-based and runs in Node, Bun, and browsers.
