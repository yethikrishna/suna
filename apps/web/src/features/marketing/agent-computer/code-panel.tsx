...
/* A real grammar is overkill for two fixed snippets, and shipping a syntax
   ...
   the two examples on this page contain: YAML keys, YAML values, comments, a
   shell prompt, and one line of command output. Same idiom as the landing
   page's `landing/code-panels.tsx`, minus the copy button — these snippets are
   here to be read, not pasted. */
