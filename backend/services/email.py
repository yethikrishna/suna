...
class EmailService:
    def __init__(self):
        ...
        self.sender_name = os.getenv('MAILTRAP_SENDER_NAME', 'Yeti Team')
    ...
    def send_welcome_email(self, user_email: str, user_name: Optional[str] = None) -> bool:
        ...
        subject = "🎉 Welcome to Yeti — Let's Get Started "
...
<head>
  ...
  <title>Welcome to Yethikrishna Yeti</title>
  <style>
    body {{
...
<body>
  <div class="container">
    <div class="logo-container">
      <img src="https://i.postimg.cc/WdNtRx5Z/yethikrishna-yeti-logo.png" alt="Yethikrishna Yeti Logo" class="logo">
    </div>
    <h1>Welcome to Yethikrishna Yeti!</h1>

    <p>Hi {user_name},</p>

    <p><em><strong>Welcome to Yethikrishna Yeti — we're excited to have you on board!</strong></em></p>
    ...
    <p>Thanks again, and welcome to the Yeti community <span class="emoji">🌞</span></p>

    <p>— The Yeti Team</p>

    <a href="https://www.yeti.so/" class="button">Go to the platform</a>
  </div>
</body>
</html>"""
...
Welcome to Yeti — we're excited to have you on board!
...
Thanks again, and welcome to the Yeti community 🌞

— The Yeti Team

Go to the platform: https://www.yeti.so/

---
© 2024 Yeti. All rights reserved.
You received this email because you signed up for a Yeti account."""
