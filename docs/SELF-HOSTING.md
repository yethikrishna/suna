# Yeti Self-Hosting Guide

This guide provides detailed instructions for setting up and hosting your own instance of Yeti, an open-source generalist AI agent.
...
- Start Yeti using your preferred method
...
3. Create a Snapshot:
   - Name: `yethikrishna/yeti:0.1.3`
   - Image name: `yethikrishna/yeti:0.1.3`
...
Yeti can be started in two ways:
...
For further assistance, join the [Yeti Discord Community](https://discord.gg/Py6pCBUUPw) or check the [GitHub repository](https://github.com/yethikrishna-ai/yeti) for updates and issues.
