...
variable "web_image" {
  ...
  type        = string
  default     = "kortix/kortix-frontend:staging-latest"
}

variable "web_certificate_arn" {
  description = "ACM wildcard certificate covering staging-fe-ecs.kortix.com."
  type        = string
...
variable "manage_dns" {
  description = "Create only staging-fe-ecs.kortix.com. This stack never manages staging.kortix.com."
  type        = bool
  default     = true
}
