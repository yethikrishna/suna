...
### 2026-07-25 — session `scheduler-release` (release integration)

Merged `origin/main` at `c2a1a447e` into the staging release candidate.
The merge preserves both append-only progress histories.
No SDK implementation, export, or public name changed in the conflict resolution.

**Final SDK gates:** `pnpm --filter @kortix/sdk typecheck` exited 0.
The built full suite reported **1255 pass / 0 fail** across 104 files with 5611
