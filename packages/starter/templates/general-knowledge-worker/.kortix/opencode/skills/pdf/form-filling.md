...
`python3 skills/pdf/formfill.py detect <file.pdf>`
...
```
python3 skills/pdf/formfill.py extract <input.pdf> <fields.json>
```
...
```
python3 skills/pdf/render.py <file.pdf> <output_dir/>
```
...
```
python3 skills/pdf/formfill.py fill <input.pdf> <values.json> <output.pdf>
```
...
```
python3 skills/pdf/layout.py extract <input.pdf> <layout.json>
```
...
```
python3 skills/pdf/render.py <input.pdf> <images_dir/>
```
...
```
python3 skills/pdf/layout.py fill <input.pdf> <fields.json> <output.pdf>
```
...
```
python3 skills/pdf/render.py <output.pdf> <verify_images/>
```
...
```
python3 skills/pdf/layout.py preview <page_number> <fields.json> <page_image> <output_image>
```
