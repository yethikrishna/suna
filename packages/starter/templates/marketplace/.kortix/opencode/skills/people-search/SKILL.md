...
- Composio-managed app (most prospecting tools): `kortix connectors add apollo --provider composio --app apollo --apply`, then `kortix connectors connect apollo` to mint a 1-click link.
