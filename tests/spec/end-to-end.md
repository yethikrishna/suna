...
Playwright journey `23-composio-connector.spec.ts` verifies Composio catalogue search in Discovery and All. One- and two-character queries, including surrounding whitespace, show “Type at least 3 characters to search.” They send no toolkit request. Three-character queries return matching cards. Deleting back to two characters restores the guidance. Clearing the search restores the catalogue.
